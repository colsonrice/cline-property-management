    ...
    },
    {
        ...
        "beforeafter": [
            ("snow-removal", "snow-clearing-before", "snow-clearing-after",
             "Driveway clearing",
             "The same driveway before and after a trigger-depth clearing."),
            ("snow-removal", "snow-parking-lot-before", "snow-parking-lot-after",
             "Commercial lot plowing",
             "The same lot before and after plowing."),
        ],
        "gallery": [
            ("snow-removal", "snow-clearing-before",
             "Snow-covered driveway before a trigger-depth clearing"),
            ("snow-removal", "snow-clearing-after",
             "The same driveway cleared to the pavement"),
            ("snow-removal", "snow-parking-lot-before",
             "Snow-covered commercial parking lot before plowing"),
            ("snow-removal", "snow-parking-lot-after",
             "The same commercial lot plowed and open"),
        ],
        "faqs": [
